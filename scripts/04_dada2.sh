...
qiime dada2 denoise-paired \
  ...
  --o-base-transition-stats "$Q2_DIR/dada2-base-transition-stats.qza" \
  --verbose
...
qiime feature-table summarize \
  ...
  --o-feature-frequencies "$Q2_DIR/table-feature-freq.qza" \
  --o-sample-frequencies "$Q2_DIR/table-sample-freq.qza" \
  --o-summary "$Q2_DIR/table-summary.qzv"
